...
const Register = () => {
    ...
    const handleSignup = () => {
        if (signupData.password === signupData.confirmpassword && signupData.password.length > 0 && signupData.username.length>0 && (validator.isUsername(signupData.username))) {
            ...
            }else if(!validator.isUsername(signupData.username)){
    ...
    return (
        <div className="signup-container">
            <div className="box">
                ...
                {/* <form id="pushing" > */}
                    <div id="email">
                        <input className="signup-input" type="username" required placeholder="username" onChange={(e) => { setSignupData({ ...signupData, email: e.target.value }) }} />
                    </div>
                    <div id="password">
